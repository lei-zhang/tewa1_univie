...
This course is the extension to the <ins>award winning</ins>\* [**BayesCog**](https://github.com/lei-zhang/BayesCog_Wien) seminar at [Faculty of Psychology](https://psychologie.univie.ac.at/), [University of Vienna](https://www.univie.ac.at/en/), as part of the  course curriculum for master's students (Mind and Brain track).

Instructor: [Dr. Lei Zhang](http://lei-zhang.net/)

Location: [virtually via Zoom] 

When: 15:00-18:15 Wednesdays (see calendar below)

Recording (previous semester): available on [YouTube](https://www.youtube.com/watch?v=8RpLF7ufZs4&list=PLfRTb2z8k2x9gNBypgMIj3oNLF8lqM44-).
...
L01: 06.10 Introduction and overview <[slides]()> <[video]()> <br />
